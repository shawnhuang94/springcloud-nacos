...
import com.nt.backend.workflow.dto.*;
import com.nt.backend.workflow.dto.json.ChildNode;
import com.nt.backend.workflow.dto.json.FormOperates;
import com.nt.backend.workflow.dto.json.SettingsInfo;
...
import com.nt.backend.workflow.vo.*;
...
import static com.nt.backend.workflow.common.CommonConstants.*;
import static com.nt.backend.workflow.common.WorkFlowConstants.PROCESS_PREFIX;
...
public class WorkspaceProcessController {
    ...
    public Result<ProcessTemplates> detail(@RequestParam("templateId") String templateId){
        ...
        processTemplates.setForworkflow(processTemplates.getTemplateId());
    ...
    public Result<Boolean> deleteProcessInstance(@RequestBody Map<String,Object> map){
        String data = MapUtil.getStr(map, "data");
        HistoricProcessInstance historicProcessInstance = historyService.createHistoricProcessInstanceQuery().processInstanceId(data).singleResult();
        if(historicProcessInstance==null){
            runtimeService.deleteProcessInstance(data,"删除");
        }
        historyService.deleteHistoricProcessInstance(data);
