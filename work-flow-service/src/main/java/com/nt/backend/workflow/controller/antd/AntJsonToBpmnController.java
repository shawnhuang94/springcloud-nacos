package com.nt.backend.workflow.controller.antd;
...
public class AntJsonToBpmnController {
    ...
    private static String create(String froworkflow, JSONObject flowNode,BpmnModel bpmnModel,Process process,
        ...
        if (Type.PARALLEL.type.equals(nodeType)) {
            return createParallelGatewayBuilder(froworkflow, flowNode,bpmnModel,process,sequenceFlows,nodeMap);
        }
        else if (Type.EXCLUSIVE.type.equals(nodeType)) {
            return createExclusiveGatewayBuilder(froworkflow, flowNode,bpmnModel,process,sequenceFlows,nodeMap);
        }
    ...
    private static String createExclusiveGatewayBuilder(String forworkflow, JSONObject flowNode,BpmnModel bpmnModel,
    ...
    private static String createParallelGatewayBuilder(String forworkflow, JSONObject flowNode,BpmnModel bpmnModel,
